...
# File paths
file_paths = {
    "read": "logs_final/timed_log_read_ppo_marlin_network_bn.csv",
    "network": "logs_final/timed_log_network_ppo_marlin_network_bn.csv",
    "write": "logs_final/timed_log_write_ppo_marlin_network_bn.csv",
